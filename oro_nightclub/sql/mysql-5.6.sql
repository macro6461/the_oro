...
-- ----------------------------
BEGIN;
INSERT INTO credencial (nombre) VALUES ('superuser');
INSERT INTO credencial (nombre) VALUES ('admin');
INSERT INTO credencial (nombre) VALUES ('Agent');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO usuario (user_name, password, actived, last_login_at) VALUES ('admin', '50b9748289910436bfdd34bda7b1c9d9', 1, null);
COMMIT;
