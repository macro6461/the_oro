<!-- NEWS LETTER -->
<div id="subscribe_form" class="page-section nl-cont">
            <div class="container">
                <div class="relative" >
                    <div id="mc_embed_signup" class="nl-form-container clearfix">
                        ...
                        <form action="http://abcgomel.us9.list-manage.com/subscribe/post-json?u=ba37086d08bdc9f56f3592af0&amp;id=e38247f7cc&amp;c=?" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="newsletterform validate" target="_blank" novalidate>   <!-- EDIT THIS ACTION URL (add "post-json?u" instead of "post?u" and appended "&amp;c=?" to the end of this URL) -->
                            <h4 class="container">Subscribe to our newsletter and get all the latest news and updates!</h4>
                            <input type="text" name="name_suscribe" class="email nl-email-input" id="mce-EMAIL" placeholder="Enter your Name" required>
                            <input type="email" value="" name="email_suscribe" class="email nl-email-input" id="mce-EMAIL" placeholder="Enter your Email Address" required>
